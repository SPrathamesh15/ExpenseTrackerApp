...
async function download(e){
    ...
    axios.get("http://13.126.112.76:3000/expense/download", {
...
async function postFiles(fileURL){
    ...
    axios.post("http://13.126.112.76:3000/expense/postfileurls", fileURLS, {
        headers: {'Authorization' : token}})
...
async function getFiles(page=1) {
    const token = localStorage.getItem('token');
    axios.get(`http://13.126.112.76:3000/expense/getfileurls?page=${page}`, {
        headers: { 'Authorization': token }
    })
        .then(response => {
...
async function ShowLeaderboard(page=1) {
    const token = localStorage.getItem('token');
    axios.get(`http://13.126.112.76:3000/premium/leaderboard?page=${page}`, { headers: { 'Authorization': token } })
        .then(response => {
...
async function BuyPremium(e){
    const token = localStorage.getItem('token');
    const response = await axios.get('http://13.126.112.76:3000/purchase/premiummembership', { headers: {'Authorization' : token }})
    ...
    var options = {
        ...
        "handler": async function (response) {
            ...
            await axios.post('http://13.126.112.76:3000/purchase/updatetransactionstatus', {
...
function handleFormSubmission(e) {
    ...
    const token = localStorage.getItem('token')
    axios.post("http://13.126.112.76:3000/expense/add-expense", expenseDetails, {
        headers: {'Authorization' : token}})
        .then((response) => {
            console.log(response);
        })
...
async function handlePageLoad() {
    ...
    const token = localStorage.getItem('token')
    axios.get("http://13.126.112.76:3000/expense/get-expenses", {
        headers: {'Authorization' : token}
    })
        .then((response) => {
    ...
    // for premium status
    try {
        const response = await axios.get("http://13.126.112.76:3000/purchase/premium-status", {
            headers: { 'Authorization': token }
        });
...
function displayPaginationControls(totalPages, currentPage) {
  ...
  async function goToPage(page) {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.get(`http://13.126.112.76:3000/expense/get-expenses?page=${page}`, {
        headers: { 'Authorization': token }
      });
...
function deleteExpense(expenseId) {
    const token = localStorage.getItem('token')
    axios.delete(`http://13.126.112.76:3000/expense/delete-expense/${expenseId}`, {
        headers: {'Authorization' : token}
    })
        .then((response) => {
